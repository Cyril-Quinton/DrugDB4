...
It allows to make fast requests on files containing drugs and their side effects. (testFile/save3.txt is this kind of file)
It allows to modify and these "databases".
